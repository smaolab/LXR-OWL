...
const Name valueNames[NUM_NAMES] PROGMEM =
{
		...
		{SHORT_FX_TYPE,CAT_EMPTY,LONG_FX_TYPE},// rstephane:  FX TYPE
		{SHORT_FX1,CAT_EMPTY,LONG_FX1},// rstephane:  PAR 1
		{SHORT_FX2,CAT_EMPTY,LONG_FX2},// rstephane:  PAR 2
		{SHORT_FX3,CAT_EMPTY,LONG_FX3},// rstephane:  PAR 3

		{SHORT_FX4,CAT_EMPTY,LONG_FX4},// rstephane:  PAR
		{SHORT_FX5,CAT_EMPTY,LONG_FX5},// rstephane:  PAR 2
		{SHORT_FX6,CAT_EMPTY,LONG_FX6},// rstephane:  PAR 3
		{SHORT_FX7,CAT_EMPTY,LONG_FX7} // rstephane:  PAR 1
...
// ------------------------------------------------------------------------------------------
	...
	/*PAR_RND_MASKTYPE6,*/		DTYPE_1B16,
	    ...
	    /*PAR_FX_TYPE */	DTYPE_1B16,  // rstephane : 16xFXs modes
			/*PAR_FX1*/	DTYPE_0B127,  // rstephane : PAR 1
	    /*PAR_FX2 */		DTYPE_0B127,  // rstephane : PAR 2
	    /*PAR_FX3 */	DTYPE_0B127,// rstephane : PAR 3
