...
enum NamesEnum
{
	...
	TEXT_FX_TYPE,	// rstephane: 16 types of effects
	TEXT_FX1,	// rstephane: PAR 1
	TEXT_FX2,	// rstephane : PAR 2
	TEXT_FX3,  // rstephane : and PAR 3
	// rstephane : Alien Wah // NOT USED !!!
	TEXT_FX4,
	TEXT_FX5,
	TEXT_FX6,
	TEXT_FX7,
...
{ // these must correspond with shortNames
	...
	SHORT_FX_TYPE, // rstephane : FX1 amount
...
enum longNamesEnum
{
	...
	LONG_FX_TYPE, // rstephane : FX1 amount
	LONG_FX1, // rstephane : FX1 parameter...
	LONG_FX2,
	LONG_FX3,
	LONG_FX4,
	LONG_FX5,
